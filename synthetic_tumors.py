...
# Dense ECM transfer region
d_opt_vals = np.linspace(40e-9, 60e-9, 100)
sigma_d_vals = np.ones(100) * 10e-9
...
_ = p_map(dataset_maker, phys2, dataset2, num_cpus=50)
hist = p_map(train_surrogate, ml2, num_cpus=50)